...
export class DriverCarsPage {
  ...
  newcar:any;
  constructor(private alertCtrl:AlertController,public user: User,private auther:Auther,private platform: Platform,private navCtrl: NavController, public http:Http) {
    this.cars=[];
